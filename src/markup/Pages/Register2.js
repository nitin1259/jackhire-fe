...
import {candidateLogin} from './../../redux/actions/candidateActions/candidateAuthActions'
...
const Register2 = ({history})=>{	
	...
	const login=useSelector(state=>state.candidateLogin);
	const {loading,candidateInfo,error}=login
								...
								<div className="login-form style-2">
									...
									<div className="tab-content nav p-b30 tab">
										<div id="login" className="tab-pane active ">
											<form className=" dez-form p-b30">
												<h3 className="form-title m-t0">Candidate Login</h3>
												<div className="dez-separator-outer m-b5">
													<div className="dez-separator bg-primary style-liner"></div>
												</div>
												<p>Enter your e-mail address and your password. </p>
												<div className="form-group">
													<input name="dzName" required="" className="form-control" value={email} onChange={(e)=>setEmail(e.target.value)} placeholder="User Email" type="email" />
												</div>
												<div className="form-group">
													<input name="dzName" required="" value={password} onChange={(e)=>setPassword(e.target.value)} className="form-control " placeholder="Type Password" type="password" />
												</div>
												<div className="form-group text-left">
													<button onClick={submitHandler} className="site-button dz-xs-flex m-r5">login</button>
											...
											<div className="text-center bottom"> 
												<Link data-toggle="tab" to='/candidate/signup' className="site-button button-md btn-block text-white">Create an account</Link> 
											</div>
										</div>
									...
									<div className="bottom-footer clearfix m-t10 m-b20 row text-center">
										<div className="col-lg-12 text-center">
											...
											<Link to= {''} >Crackhire </Link> All rights reserved.</span> 
										</div>
									</div>	
								</div>
							</div>
