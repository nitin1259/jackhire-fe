...
import {getEmployerDetails,employerLogout} from './../../redux/actions/employeeActions/employeeAuthActions'
...
const Companyprofile=({history})=> {
	...
	useEffect(()=>{
		if(!employerInfo){
			...
			dispatch(getEmployerDetails())
		}
	},[dispatch,employerInfo])
											...
											<div className="candidate-info company-info">
												<div className="candidate-detail text-center">
													...
													<div className="candidate-title">
														<h4 className="m-b5"><Link to={""}>{user?.company_name}</Link></h4>
													</div>
												</div>
												<ul>
												...
												<div className="row m-b30">
													<div className="col-lg-6 col-md-6">
														<div className="form-group">
															...
															<input type="text" className="form-control" placeholder={user?.company_name} />
														</div>
													</div>
													<div className="col-lg-6 col-md-6">
														<div className="form-group">
