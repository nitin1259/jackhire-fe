						...
						<div className="container clearfix">
							...
							<div className="extra-nav">
								<div className="extra-cell">
									<Link to={"/candidate/login"} className="site-button"><i className="fa fa-user"></i>Login</Link>
									
									<Link to ={'/employee/login'} className="site-button"><i className="fa fa-lock"></i> For Employer </Link>
								</div>
							</div>
